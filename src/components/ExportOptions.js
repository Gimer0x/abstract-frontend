...
const ExportOptions = ({
  ...
  const handleExport = async format => {
    ...
    if (format === 'mp3') {
      setExportMessage(
        'Generating professional audio narration... This may take a moment as we create high-quality speech synthesis.',
      );
    } else {
      ...
      <div className='export-options'>
        ...
        <div className='guest-export-message'>
          ...
          <div className='guest-content'>
            ...
            <p>
              Guest users can copy the summary text, but need to sign in to
              download documents in PDF, Word, Text, or Audio formats.
            </p>
